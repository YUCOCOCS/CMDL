...
def parseArgs():
    ...
    parser.add_argument('--cfgfilepath', dest='cfgfilepath', help='config file path you want to use',default='/home/y212202015/SSEG/sseg/configs/upernet/upernet_resnet50_camvid.py' ,type=str)
