...
def parseArgs():
    ...
    parser.add_argument('--nproc_per_node', dest='nproc_per_node', help='number of process per node', default=2, type=int)
    parser.add_argument('--cfgfilepath', dest='cfgfilepath', help='config file path you want to use', type=str,default='/home/y212202015/SSEG/sseg/configs/ours/ADE20K/CCNet_ResNet101.py')
    parser.add_argument('--evalmode', dest='evalmode', help='evaluate mode, support online and offline', default='offline', type=str)
    parser.add_argument('--checkpointspath', dest='checkpointspath', help='checkpoints you want to resume from', default='/home/y212202015/SSEG/sseg/ours_CCNet_resnet101os8_ade20k/best.pth',type=str)
